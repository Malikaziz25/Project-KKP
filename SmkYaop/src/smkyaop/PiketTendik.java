 ...
 */
public class PiketTendik extends javax.swing.JFrame {
    ...
    private String generateId(){
        String str = "";
        String query = "SELECT idpiket FROM piket ORDER BY idpiket DESC";
        try{
            PreparedStatement ps = Database.getConn().prepareStatement(query);
            ResultSet rs = ps.executeQuery();
            if(rs.next()){
                int nomer = Integer.parseInt(rs.getString("idpiket").substring(2))+1;
    ...
    private void loadData(String keys){
      String[] header= {"ID Piket","ID PEgawai","Nama Pegawai","Tanggal Piket"};
      ...
      if(keys != ""){
        ...
        sql = "SELECT pegawai.namapegawai as np,piket.* FROM pegawai INNER JOIN piket ON pegawai.idpegawai = piket.idpegawai ";
...
//      Object[] Baris ={"ID Pegawai","ID Jabatan","NIP", "Nama Pegawai", "Jenis kelamin","Tempat,Tanggal Lahir","Alamat","Telp","Status","Wali Kelas"};
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        ...
        if(idpegawai.isEmpty() || idpiket.isEmpty() || tgl == null){
            Helper.alert("Isi Form Dahulu!");
            return;
        }
        
        String query = "INSERT INTO piket VALUES(?,?,?,?)";
        try{
            PreparedStatement ps = Database.getConn().prepareStatement(query);
    ...
    private void tableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tableMouseClicked
        ...
        try {
            ...
            Logger.getLogger(PiketTendik.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        ...
        if(tanya == JOptionPane.YES_OPTION){        
            ...
            String query = "DELETE FROM piket WHERE idpiket = ?";
            try{
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PiketTendik.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
