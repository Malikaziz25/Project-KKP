...
public class UserForm extends javax.swing.JFrame {
    ...
    private void loadData(String keys){
        String header[] = {"ID","Username","Password","Hak Akses"};
        ...
        String addQuery = "";
        if(keys != ""){
            addQuery = " WHERE username LIKE '%"+keys+"%'";
        }
        try{            
    ...
    private void initComponents() {
        ...
        combo.setFont(new java.awt.Font("Tahoma", 0, 19)); // NOI18N
        combo.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "--- Silahkan Pilih Akses ---", "Kepala TU", "Staff TU" }));
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(tfNama)
                            .addComponent(jpPass, javax.swing.GroupLayout.DEFAULT_SIZE, 266, Short.MAX_VALUE))
                        .addGap(114, 114, 114))
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        .addGap(41, 41, 41)
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        ...
                        .addComponent(jLabel5)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(jpPass, javax.swing.GroupLayout.PREFERRED_SIZE, 37, javax.swing.GroupLayout.PREFERRED_SIZE)))
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        ...
        String password = String.valueOf(jpPass.getPassword());
        String jenis = "";
        if(nama.isEmpty()){
            Helper.alert("Isi Username dulu!");
            return;
        }
        if(password.isEmpty() ){
            Helper.alert("Isi Password benar!");
            return;
        }
        if(index == 0){
            Helper.alert("Pilih Akses dahulu!");
            return;
        }        
        
        jenis = combo.getSelectedItem().toString();
        String query = "INSERT INTO user(username,password,akses) VALUES(?,?,?)";
        try{
            Connection conn = Database.getConn();
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        ...
        if(tanya == JOptionPane.YES_OPTION && !id.isEmpty() ){
            try{
                PreparedStatement ps = Database.getConn().prepareStatement("DELETE fROM user WHERE iduser = ?");
    ...
    private void tableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tableMouseClicked
        ...
        jpPass.setText(this.getFromTable(row)[2]);
        combo.setSelectedItem(this.getFromTable(row)[3]);        
    ...
    private void btnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditActionPerformed
        ...
        if(tanya == JOptionPane.YES_OPTION && !id.isEmpty() ){
            ...
            if(password.isEmpty()){
                Helper.alert("Isi Password!");
                return;
            }
            if(index == 0){
                Helper.alert("Pilih Jakses dahulu!");
                return;
            }        
            ...
            try{
                String query = "UPDATE user SET username = ?,password = ?,akses = ? WHERE iduser = ?";
